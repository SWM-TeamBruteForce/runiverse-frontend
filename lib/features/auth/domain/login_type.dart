/// 이 계정이 어떻게 만들어졌는가. `GET /api/v1/users/me`가 함께 싣는다(명세 10-1).
///
...
///
/// ## ⚠️ settings가 아니라 auth에 있다
///
/// 쓰는 곳은 설정 화면 하나뿐이지만 **오는 곳이 `/users/me`**라 인증이 소유한다.
/// 예전에는 `/users/me/account`라는 전용 경로가 있어 settings에 두었는데,
/// 그 경로가 없어지면서 계정 정보가 `/users/me`로 합쳐졌다.
///
