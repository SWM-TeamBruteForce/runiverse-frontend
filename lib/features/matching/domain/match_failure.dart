...
enum MatchFailure {
  ...
  /// 이미 시작한 러닝이라 취소할 수 없다(`MATCH_ALREADY_STARTED`).
  ///
  /// ⚠️ **앱이 상태를 늦게 알고 있다는 신호다.** 서버는 시작 시각에 방을
  /// 올리는데, 그사이 스트림이 끊겨 있었으면 앱은 아직 대기 중인 줄 안다.
  /// 받으면 나가기를 다시 시도할 것이 아니라 **유저 상태를 다시 읽어야** 한다.
  alreadyStarted,
